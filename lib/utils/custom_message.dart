...
class CustomMessage {
  static String defaultWhatsAppMessage({required Position position}) =>
  ...
  static String defaultSMS({required Position position}) =>
      "I'm in danger! Help me ASAP. My location: https://maps.google.com/?q=${position.latitude},${position.longitude}";
}
